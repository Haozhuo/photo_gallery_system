                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="form-group">
                                <a class="thumbnail" href="#"><img src="<?php echo "./images/".$photo->photo_filename; ?>" alt=""></a>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="description" id="" cols="30" rows="10"><?php echo $photo->photo_description; ?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4" >
                            ...
                            <div class="inside">
                              <div class="box-inner">
                                 ...
                                 <p class="text">
                                  File Type: <span class="data"><?php $splited = explode('.',$photo->photo_filename); echo $splited[count($splited)-1];?></span>
                                 </p>
                                 <p class="text">
